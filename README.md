...
This README and the published manual describe **development on main**. The installer
fetches the **latest release**. The first-run guide, detailed Home freshness context,
`O` tool menu and `W` Worktree workspace are development features added after v0.3.1.
See the [changelog](CHANGELOG.md) for released versus unreleased changes.
