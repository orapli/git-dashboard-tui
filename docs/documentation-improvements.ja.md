...
この記録はコミット `b69fa14` 時点の対応です。当時はアプリの既知の不具合を修正せず、制限と回避手順を記載しました。
その後の修正は[機能改善の記録](functional-improvements.ja.md)を参照してください。
...
push後、コミット `b69fa14` のCIとGitHub Pagesへの反映はともに成功しました。
