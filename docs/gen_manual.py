...
def render_index() -> str:
    ...
    out = ['<!doctype html>', '<html lang="en">', "<head>",
           ...
           "never uses sudo. The shell installer supports Linux/macOS; Windows uses the release ZIP.</p><p>This site documents v0.4.0; the installer downloads the latest release. / このサイトはv0.4.0、インストーラは最新リリースを対象とします。 <a href='manual.html#versions'>Version details</a> · <a href='manual.ja.html#versions'>バージョンの説明</a></p></section>",
